...
@php
    // Fetch supplier via product -> user
    $product = $order->product;
    $variant = $order->variant;
    $supplier = $product->user; // seller details
@endphp
...
<script>
    ...
    // When the button is clicked, toggle the dropdown visibility
    ...
    // When either anchor tag is clicked, close the dropdown
